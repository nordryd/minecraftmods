...
public class DimensionalGenerator<F extends IFeatureConfig, P extends IPlacementConfig> extends CompositeFeature<F, P>
{
	...
	@Override
	public boolean func_212245_a(IWorld world, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_,
			BlockPos p_212245_4_, NoFeatureConfig p_212245_5_) {
