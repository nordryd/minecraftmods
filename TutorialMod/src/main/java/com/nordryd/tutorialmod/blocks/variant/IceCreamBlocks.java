 ...
 * @author Nordryd
 */
public class IceCreamBlocks extends Block implements IHasModel, IMetaName
{
	...
	public IceCreamBlocks(String name) {
		super(Material.SAND);
	...
	public void registerModels() {
		for (int i = 0; i < EnumHandler.Flavors.values().length; i++) {
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "blocks_" + EnumHandler.Flavors.values()[i].getName(),
					"inventory");
		}
	}
}
