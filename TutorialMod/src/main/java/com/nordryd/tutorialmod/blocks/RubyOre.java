...
/**
 * Class for <b>Ruby Ore</b>, and its specific properties.<br/>
...
{
	public RubyOre(String name, Material material, int dimensionId, int chance, int minVeinSize, int maxVeinSize, int minY, int maxY) {
