...
public class VanillaTree extends WorldGenAbstractTree
{
	public static final IBlockState LOG = ModBlocks.LOGS.getDefaultState().withProperty(Logs.VARIANT, EnumHandler.Flavors.VANILLA);
	public static final IBlockState LEAF = ModBlocks.LEAVES.getDefaultState().withProperty(Leaves.VARIANT, EnumHandler.Flavors.VANILLA);
