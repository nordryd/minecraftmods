...
public class TreeGenerator implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		...
		case Dimensions.OVERWORLD:
			generateTree(VANILLA, world, random, chunkX, chunkZ, 1, ModBlocks.ICE_CREAM_BLOCKS, Biomes.EXTREME_HILLS.getClass(),
					ModBiomes.ICE_CREAM.getClass());
			generateTree(MINT, world, random, chunkX, chunkZ, 1, ModBlocks.ICE_CREAM_BLOCKS, Biomes.EXTREME_HILLS.getClass(),
					ModBiomes.ICE_CREAM.getClass());
			generateTree(STRAWBERRY, world, random, chunkX, chunkZ, 1, ModBlocks.ICE_CREAM_BLOCKS, Biomes.EXTREME_HILLS.getClass(),
					ModBiomes.ICE_CREAM.getClass());
			generateTree(CHOCOLATE, world, random, chunkX, chunkZ, 1, ModBlocks.ICE_CREAM_BLOCKS, Biomes.EXTREME_HILLS.getClass(),
					ModBiomes.ICE_CREAM.getClass());
			break;
	...
	private void generateTree(WorldGenerator generator, World world, Random random, int chunkX, int chunkZ, int chance, Block topBlock,
			Class<?>... classes) {
