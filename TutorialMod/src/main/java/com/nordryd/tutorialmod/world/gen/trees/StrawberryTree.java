...
public class StrawberryTree extends WorldGenAbstractTree
{
	public static final IBlockState LOG = ModBlocks.LOGS.getDefaultState().withProperty(Logs.VARIANT, EnumHandler.Flavors.STRAWBERRY);
	public static final IBlockState LEAF = ModBlocks.LEAVES.getDefaultState().withProperty(Leaves.VARIANT, EnumHandler.Flavors.STRAWBERRY);
	public static final int HEIGHT_VARIATION = 3;
	private int minHeight;

	public StrawberryTree() {
		super(false);
		this.minHeight = 12;
	}
